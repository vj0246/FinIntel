...
const TOOL_LABEL = {
  ...
  get_quarterly_results: "Quarterly results", get_annual_results: "Annual results",
  get_key_stats: "Key stats", get_balance_sheet: "Balance sheet",
  get_cash_flow: "Cash flow", get_shareholding_pattern: "Shareholding",
  get_quant_metrics: "Quant metrics", get_market_mood: "Market mood",
  get_next_earnings: "Next earnings", get_competitors: "Competitors",
  compare_quarterly: "Compare quarters", compare_fundamentals: "Compare fundamentals",
  get_company_ecosystem: "Ecosystem map",
